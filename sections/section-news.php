    ...
    echo '<div class="container">';
        ...
        if( $pixova_lite_q->have_posts() ) {
           ...
           echo '<div class="mt-blog-posts text-center">';
                            ...
                            echo '<div class="'.$pixova_lite_news_size.'" style="width: 100%;">';
                                echo '<div class="thumbnail">';
                                    if( has_post_thumbnail($pixova_lite_q->post->ID )) {
                                        ...
                                        echo '</a>';
                                    } else if( !has_post_thumbnail() && $random_featured_images == 'images_enabled' ) {
            ...
            if( !empty( $page_which_uses_blog_template ) ) {
                echo '<a class="btn btn-cta-dark" href="' . esc_url( get_permalink( $page_which_uses_blog_template[0]  ) ) . '">' . __( 'Visit our blog', 'pixova-lite' ) . '</a>';
            }
