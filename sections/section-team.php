...
if ( $pixova_lite_team_member_1_image && $pixova_lite_team_member_2_image && $pixova_lite_team_member_3_image && $pixova_lite_team_member_4_image && ! $pixova_lite_team_member_5_image ) {
	$sizing = 'col-sm-3';
} elseif ( '' == $pixova_lite_section_title && '' == $pixova_lite_section_title ) {
	return;
} else {
	$sizing = '';
}
...
if ( isset( $pixova_lite_team_member_1_image ) && ! empty( $pixova_lite_team_member_1_image ) ) {
	echo '<div class="pixova-team ' . $sizing . ' pixova-lite-team-member-1">';
	echo '<img class="pixova-team-img" src="' . esc_url( $pixova_lite_team_member_1_image ) . '" alt="' . ( ( $pixova_lite_team_member_1_name ) ? esc_attr( $pixova_lite_team_member_1_name ) : '' ) . '">';

	echo '<div class="pixova-team-member-name">';
	echo wp_kses_post( $pixova_lite_team_member_1_name );
	echo '</div><!--/.pixova-team-member-name-->';
	if ( $pixova_lite_team_member_1_fburl || $pixova_lite_team_member_1_dribbble_url || $pixova_lite_team_member_1_email ) {
		echo '<div class="pixova-team-description">';
		echo '<div class="pixova-team-member-icons">';
		...
		echo '</div><!--/.pixova-team-member-icons-->';
		echo '</div><!--/.pixova-team-description-->';
	}// End if().

	echo '</div> <!--/.pixova-team-->';
}// End if().

if ( isset( $pixova_lite_team_member_2_image ) && ! empty( $pixova_lite_team_member_2_image ) ) {
	echo '<div class="pixova-team ' . $sizing . ' pixova-lite-team-member-2">';

	echo '<img class="pixova-team-img" src="' . esc_url( $pixova_lite_team_member_2_image ) . '" alt="' . ( ( $pixova_lite_team_member_2_name ) ? esc_attr( $pixova_lite_team_member_2_name ) : '' ) . '">';
...
if ( isset( $pixova_lite_team_member_3_image ) && ! empty( $pixova_lite_team_member_3_image ) ) {
	echo '<div class="pixova-team ' . $sizing . ' pixova-lite-team-member-3">';

	echo '<img class="pixova-team-img" src="' . esc_url( $pixova_lite_team_member_3_image ) . '" alt="' . ( ( $pixova_lite_team_member_3_name ) ? esc_attr( $pixova_lite_team_member_3_name ) : '' ) . '">';
...
if ( isset( $pixova_lite_team_member_4_image ) && ! empty( $pixova_lite_team_member_4_image ) ) {
	echo '<div class="pixova-team ' . $sizing . ' pixova-lite-team-member-4">';

	echo '<img class="pixova-team-img" src="' . esc_url( $pixova_lite_team_member_4_image ) . '" alt="' . ( ( $pixova_lite_team_member_4_name ) ? esc_attr( $pixova_lite_team_member_4_name ) : '' ) . '">';
...
if ( isset( $pixova_lite_team_member_5_image ) && ! empty( $pixova_lite_team_member_5_image ) ) {
	echo '<div class="pixova-team pixova-lite-team-member-5">';

	echo '<img class="pixova-team-img" src="' . esc_url( $pixova_lite_team_member_5_image ) . '" alt="' . ( ( $pixova_lite_team_member_5_name ) ? esc_attr( $pixova_lite_team_member_5_name ) : '' ) . '">';
