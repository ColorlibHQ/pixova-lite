	...
	public function pixova_lite_welcome_admin_notice() {
		?>
			<div class="updated notice is-dismissible">
				<p><?php echo sprintf( esc_html__( 'Welcome! Thank you for choosing Pixova Lite! To fully take advantage of the best our theme can offer please make sure you visit our %swelcome page%s.', 'pixova-lite' ), '<a href="' . esc_url( admin_url( 'themes.php?page=pixova-lite-welcome' ) ) . '">', '</a>' ); ?></p>
