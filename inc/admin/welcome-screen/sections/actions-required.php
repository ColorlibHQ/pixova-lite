...
<div id="actions_required" class="pixova-lite-tab-pane">

	<h1><?php esc_html_e( 'Actions recommend to make this theme look like in the demo.' ,'pixova-lite' ); ?></h1>
	...
	if ( 0 == $nr_actions_required ) :
		echo '<p>' . __( 'Hooray! There are no required actions for you right now.','pixova-lite' ) . '</p>';
	endif;
	?>
