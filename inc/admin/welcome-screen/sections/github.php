...
<div id="github" class="pixova-lite-tab-pane">

	<h1><?php esc_html_e( 'How can I contribute?', 'pixova-lite' ); ?></h1>
	...
	<div class="pixova-tab-pane-half pixova-tab-pane-first-half">
		...
		<p>
			<a href="<?php echo esc_url( 'https://github.com/MachoThemes/pixova-lite' ); ?>" class="github-button button button-primary"><?php esc_html_e( 'Pixova Lite on GitHub', 'pixova-lite' ); ?></a>
		</p>
		<hr>
	</div>

	<div class="pixova-tab-pane-half">
		<p><strong><?php esc_html_e( 'Are you a polyglot? Want to translate Pixova Lite into your own language?', 'pixova-lite' ); ?></strong></p>

		<p><?php esc_html_e( 'Get involved at WordPress.org.', 'pixova-lite' ); ?></p>

		<p>
			<a href="<?php echo esc_url( 'https://translate.wordpress.org/projects/wp-themes/pixova-lite' ); ?>" class="translate-button button button-primary"><?php _e( 'Translate Pixova Lite', 'pixova-lite' ); ?></a>
		</p>
		<hr>
	</div>
