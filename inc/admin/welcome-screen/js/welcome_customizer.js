jQuery(document).ready(function() {
    ...
    if ((typeof pixova_aboutpage !== 'undefined') && (typeof pixova_nr_actions_required !== 'undefined') && (pixova_nr_actions_required != '0')) {
        jQuery('#accordion-section-themes .accordion-section-title').append('<a href="' + pixova_aboutpage + '"><span class="pixova-lite-actions-count">' + pixova_nr_actions_required + '</span></a>');
    }
