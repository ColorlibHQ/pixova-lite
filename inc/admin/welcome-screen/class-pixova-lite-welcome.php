...
class Pixova_Lite_Welcome {
	...
	public function pixova_lite_welcome_register_menu() {
		add_theme_page( 'About Pixova Lite', 'About Pixova Lite', 'activate_plugins', 'pixova-lite-welcome', array( $this, 'pixova_lite_welcome_screen' ) );
	}
	...
	public function pixova_lite_welcome_admin_notice() {
		?>
			<div class="updated notice is-dismissible">
				<p><?php echo sprintf( esc_html__( 'Welcome! Thank you for choosing Pixova Lite! To fully take advantage of the best our theme can offer please make sure you visit our %1$swelcome page%2$s.', 'pixova-lite' ), '<a href="' . esc_url( admin_url( 'themes.php?page=pixova-lite-welcome' ) ) . '">', '</a>' ); ?></p>
				<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=pixova-lite-welcome' ) ); ?>" class="button" style="text-decoration: none;"><?php _e( 'Get started with Pixova Lite', 'pixova-lite' ); ?></a></p>
			</div>
		<?php
	}
	...
	public function pixova_lite_welcome_style_and_scripts( $hook_suffix ) {
		...
		if ( 'appearance_page_pixova-lite-welcome' == $hook_suffix ) {
			wp_enqueue_style( 'pixova-lite-welcome-screen-css', get_template_directory_uri() . '/inc/admin/welcome-screen/css/welcome.css' );
			wp_enqueue_script( 'pixova-lite-welcome-screen-js', get_template_directory_uri() . '/inc/admin/welcome-screen/js/welcome.js', array( 'jquery' ) );
			...
			if ( ! empty( $pixova_lite_required_actions ) ) :
				foreach ( $pixova_lite_required_actions as $pixova_required_action_value ) :
					if ( ( ! isset( $pixova_required_action_value['check'] ) || ( isset( $pixova_required_action_value['check'] ) && ( false == $pixova_required_action_value['check'] ) ) ) && ((isset( $pixova_show_required_actions[ $pixova_required_action_value['id'] ] ) && ( true == $pixova_show_required_actions[ $pixova_required_action_value['id'] ] )) || ! isset( $pixova_show_required_actions[ $pixova_required_action_value['id'] ] ) ) ) :
						$nr_actions_required++;
					endif;
				endforeach;
			endif;

			wp_localize_script( 'pixova-lite-welcome-screen-js', 'pixovaLiteWelcomeScreenObject', array(
	...
	public function pixova_lite_welcome_scripts_for_customizer() {
		...
		wp_enqueue_style( 'pixova-lite-welcome-screen-customizer-css', get_template_directory_uri() . '/inc/admin/welcome-screen/css/welcome_customizer.css' );
		wp_enqueue_script( 'pixova-lite-welcome-screen-customizer-js', get_template_directory_uri() . '/inc/admin/welcome-screen/js/welcome_customizer.js', array( 'jquery' ), '20120206', true );
		...
		wp_localize_script( 'pixova-lite-welcome-screen-customizer-js', 'pixovaLiteWelcomeScreenCustomizerObject', array(
			'nr_actions_required' => $nr_actions_required,
			'aboutpage' => esc_url( admin_url( 'themes.php?page=pixova-lite-welcome#actions_required' ) ),
	...
	public function pixova_lite_welcome_screen() {
		...
		<ul class="pixova-lite-nav-tabs" role="tablist">
			<li role="presentation" class="active"><a href="#getting_started" aria-controls="getting_started" role="tab" data-toggle="tab"><?php esc_html_e( 'Getting started','pixova-lite' ); ?></a></li>
			<li role="presentation" class="pixova-lite-w-red-tab"><a href="#actions_required" aria-controls="actions_required" role="tab" data-toggle="tab"><?php esc_html_e( 'Actions required','pixova-lite' ); ?></a></li>
			<?php /* ?>
				<li role="presentation"><a href="#child_themes" aria-controls="child_themes" role="tab" data-toggle="tab"><?php esc_html_e( 'Child themes','pixova-lite'); ?></a></li>
			<?php */ ?>
			<li role="presentation"><a href="#github" aria-controls="github" role="tab" data-toggle="tab"><?php esc_html_e( 'Contribute','pixova-lite' ); ?></a></li>
			<li role="presentation"><a href="#changelog" aria-controls="changelog" role="tab" data-toggle="tab"><?php esc_html_e( 'Changelog','pixova-lite' ); ?></a></li>
			<li role="presentation"><a href="#free_pro" aria-controls="free_pro" role="tab" data-toggle="tab"><?php esc_html_e( 'Free VS PRO','pixova-lite' ); ?></a></li>
		</ul>

		<div class="pixova-lite-tab-content">
	...
	*/
	...
	public function pixova_lite_welcome_free_pro() {
		require_once( get_template_directory() . '/inc/admin/welcome-screen/sections/free-pro.php' );
	}
}
