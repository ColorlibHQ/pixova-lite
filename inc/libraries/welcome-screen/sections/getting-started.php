...
<div class="feature-section three-col has-3-columns is-fullwidth">
	<div class="col column">
		...
		<?php if ( 0 === $count ) { ?>
			<p><span class="dashicons dashicons-yes"></span>
				<a href="<?php echo esc_url( $this->generate_admin_url( 'recommended_actions' ) ); ?>"><?php esc_html_e( 'No recommended actions left to perform', 'pixova-lite' ); ?></a>
			</p>
		<?php } else { ?>
			<p><span class="dashicons dashicons-no-alt"></span>
				<a href="<?php echo esc_url( $this->generate_admin_url( 'recommended_actions' ) ); ?>"><?php esc_html_e( 'Check recommended actions', 'pixova-lite' ); ?></a>
			</p>
		<?php }; ?>
	</div><!--/.col-->
	...
	<div class="col column">
		...
		<p>
			<a target="_blank" href="<?php echo esc_url( 'https://colorlib.com/wp/support/pixova/' ); ?>"><?php esc_html_e( 'Full documentation', 'pixova-lite' ); ?></a>
		</p>
	</div><!--/.col-->
	...
	<div class="col column">
		...
		<p>
			<a target="_blank" href="<?php echo esc_url( $customizer_url ); ?>" class="button button-primary"><?php esc_html_e( 'Go to Customizer', 'pixova-lite' ); ?></a>
		</p>
	</div><!--/.col-->
</div><!--/.feature-section-->
