 ...
 * Custom logo support.
 *
 * This was inc/next-compatible.php, everything in it wrapped in a check for
 * WordPress newer than 4.4.2 -- the release that introduced the custom logo.
 * The theme requires 5.2, so the check could only ever be true.
 *
 * @package Pixova Lite
 */
